...
const SUB_DESCRIPTIONS = {
	...
	garderobnye: 'Стильная гардеробная в стиле лофт с индустриальным характером',
	polki: 'Настенная полка',
	'vinnye-bary': 'Винный шкаф или бар в стиле лофт',
	stoiki: 'Стойка для бара',
	kozyrek: 'Козырек в стиле лофт',
	...
	'int-art': 'Интерьерный арт-декор',
	reshetki: 'Металлическая решётка на окно в стиле лофт',
...
const PRICE_RANGES_BYN = {
	...
	garderobnye: { min: 780, max: 2200 },
	polki: { min: 95, max: 380 },
	'vinnye-bary': { min: 450, max: 3200 },
	stoiki: { min: 380, max: 1100 },
	kozyrek: { min: 1200, max: 4500 },
